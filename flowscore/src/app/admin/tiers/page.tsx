    ...
    <div className="mx-auto max-w-5xl">
      <div>
        ...
        <p className="mt-1 max-w-2xl text-sm text-slate-500">
          ...
          stable we'll move them into the database for live editing.
        </p>
      </div>
          ...
          >
            <div className="flex items-baseline justify-between gap-3">
              ...
              <p className="text-sm text-slate-500">
                <span className="text-slate-900 font-semibold">{t.price}</span>
                {t.priceSuffix}
              </p>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 rounded-lg bg-slate-50 p-3 text-xs text-slate-600">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-slate-900">
                  {t.leadsPerMonth === -1 ? "Unlimited" : t.leadsPerMonth}
                </p>
              </div>
            </div>
          </div>
